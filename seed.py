...
like1 = Like(is_liked_username=test1.username, is_liking=test4.username)
like2 = Like(is_liked_username=test1.username, is_liking=test2.username)
db.session.add(like1)

friend1 = Friend(is_friended_username=test1.username,
                 is_friending=test2.username)
